...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'https://github.com/phenopackets/core-ig/StructureDefinition/acmg-pathogenicity-classification']) &gt;= 1">extension with URL = 'https://github.com/phenopackets/core-ig/StructureDefinition/acmg-pathogenicity-classification': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/phenopackets/core-ig/StructureDefinition/acmg-pathogenicity-classification']) &lt;= 1">extension with URL = 'https://github.com/phenopackets/core-ig/StructureDefinition/acmg-pathogenicity-classification': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/phenopackets/core-ig/StructureDefinition/therapeutic-actionability']) &gt;= 1">extension with URL = 'https://github.com/phenopackets/core-ig/StructureDefinition/therapeutic-actionability': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/phenopackets/core-ig/StructureDefinition/therapeutic-actionability']) &lt;= 1">extension with URL = 'https://github.com/phenopackets/core-ig/StructureDefinition/therapeutic-actionability': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/phenopackets/core-ig/StructureDefinition/vrs-object']) &lt;= 1">extension with URL = 'https://github.com/phenopackets/core-ig/StructureDefinition/vrs-object': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/phenopackets/core-ig/StructureDefinition/vcf-info']) &lt;= 1">extension with URL = 'https://github.com/phenopackets/core-ig/StructureDefinition/vcf-info': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/phenopackets/core-ig/StructureDefinition/molecule-context']) &gt;= 1">extension with URL = 'https://github.com/phenopackets/core-ig/StructureDefinition/molecule-context': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/phenopackets/core-ig/StructureDefinition/molecule-context']) &lt;= 1">extension with URL = 'https://github.com/phenopackets/core-ig/StructureDefinition/molecule-context': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation/f:component">
      ...
      <sch:assert test="count(f:value[x]) &gt;= 1">value[x]: minimum cardinality of 'value[x]' is 1</sch:assert>
      <sch:assert test="count(f:value[x]) &gt;= 1">value[x]: minimum cardinality of 'value[x]' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/phenopackets/core-ig/StructureDefinition/phred-quality-score']) &lt;= 1">extension with URL = 'https://github.com/phenopackets/core-ig/StructureDefinition/phred-quality-score': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:value[x]) &gt;= 1">value[x]: minimum cardinality of 'value[x]' is 1</sch:assert>
      <sch:assert test="count(f:value[x]) &gt;= 1">value[x]: minimum cardinality of 'value[x]' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://github.com/phenopackets/core-ig/StructureDefinition/filter-status']) &lt;= 1">extension with URL = 'https://github.com/phenopackets/core-ig/StructureDefinition/filter-status': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:value[x]) &gt;= 1">value[x]: minimum cardinality of 'value[x]' is 1</sch:assert>
      <sch:assert test="count(f:value[x]) &gt;= 1">value[x]: minimum cardinality of 'value[x]' is 1</sch:assert>
      <sch:assert test="count(f:value[x]) &gt;= 1">value[x]: minimum cardinality of 'value[x]' is 1</sch:assert>
      <sch:assert test="count(f:value[x]) &gt;= 1">value[x]: minimum cardinality of 'value[x]' is 1</sch:assert>
