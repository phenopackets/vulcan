...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Provenance/f:agent">
      <sch:assert test="true()">prov-1: Who and onBehalfOf cannot be the same</sch:assert>
      <sch:assert test="true()">prov-3: If who is an organization, onBehalfOf can't be a PractitionerRole within that organization</sch:assert>
      <sch:assert test="true()">prov-2: If who is a PractitionerRole, onBehalfOf can't reference the same Practitioner</sch:assert>
    </sch:rule>
