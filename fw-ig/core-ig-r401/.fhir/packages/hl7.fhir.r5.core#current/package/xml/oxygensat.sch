...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation/f:specimen">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="starts-with(f:member/f:entity/f:reference/@value, 'Specimen/') or contains(f:member/f:entity/f:reference/@value, '/Specimen/') or not(f:specimen/@value = 'Specimen')">If Observation.specimen is a reference to Group, the group can only have specimens (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
