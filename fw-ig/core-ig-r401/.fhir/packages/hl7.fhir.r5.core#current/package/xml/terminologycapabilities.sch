...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:TerminologyCapabilities">
      ...
      <sch:assert test="count(f:software | f:implementation | f:description) &gt; 0">tcp-2: A Terminology Capability statement SHALL have at least one of description, software, or implementation element</sch:assert>
