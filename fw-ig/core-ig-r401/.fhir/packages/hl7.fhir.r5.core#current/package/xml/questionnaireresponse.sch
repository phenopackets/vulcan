...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:QuestionnaireResponse//f:item">
      <sch:assert test="not(exists(//f:item[exists(f:answer/f:value)][preceding-sibling::f:item/f:linkId/@value=current()/f:linkId/@value]))">qrs-2: Repeated answers are combined in the answers array of a single item</sch:assert>
